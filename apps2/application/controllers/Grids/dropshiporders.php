...
class Dropshiporders extends BP_Controller {
    ...
    public function index() {
        ...
        $this->title = "MI Technologiesinc - DropShip )rders";

        $this->description = "DropShip Orders";
        ...
        $SQL = "SELECT * FROM OrderManager.dbo.fn_DropShip ({$data['selectedYear']},{$data['selectedcart']})";

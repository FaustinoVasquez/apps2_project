...
class Salesbycsrmx extends BP_Controller {
    ...
    public function index() {
        ...
        $SQL = "SELECT TOP(10) upper(a.EnteredBy) as EnteredBy,[OrderManager].[dbo].fn_Get_UserName(a.EnteredBy) as Csr, sum(a.ProductTotal) as OrderCount
                FROM [OrderManager].[dbo].[Orders] a
                WHERE (a.OrderDate between '{$data['dateFrom']}' and '{$data['dateTo']}')
                AND ([OrderManager].[dbo].fn_Get_UserName(a.EnteredBy) like '%csr*mx%') 

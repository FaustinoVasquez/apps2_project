...
class Rptvbulb extends BP_Controller {
    ...
    function index() {
        ...
        $this->title = "MI Technologiesinc - RPTV Bulb";

        $this->description = "RPTV Bulb";

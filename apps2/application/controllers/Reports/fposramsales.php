...
class FPOsramSales extends BP_Controller {
    ...
    function index() { 
        ...
        $this->title = "MI Technologiesinc - FP Osram Sales Report";
        ...
        $data = array( 
            ...
            'from' => '/Reports/fposramsales',
            'caption' => 'FP Osram Sales',
            'export' => 'FPOsramSales',
            'sort' => 'desc',
            'baseUrl' => base_url(),
        );

        $data['colNames'] = "['BareBulb','SKUSold','Name','Last30DaysSold','Last60DaysSold','Last90DaysSold','QOH','vQOH','tQOH','FBAQty','FBAInboundQty','PendingFBANeeded','BackOrder']";
    ...
    function getData() {
        ...
        $selectSlice = 'SELECT [BareBulb]
                            ...
                            ,[Backorder]';
        $from = ' FROM';
        $table = ' [Inventory].[dbo].[FP-OSRAM-Sales-Report] ';
        $where ='';

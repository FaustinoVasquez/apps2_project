...
class FPPhilipsSales extends BP_Controller {
    ...
    function index() { 
        ...
        $data = array( 
            ...
            'from' => '/Reports/fpphilipssales',
            'caption' => 'FP Philips Sales',
            'export' => 'FPPhilipsSales',
            'sort' => 'desc',
            'baseUrl' => base_url(),
        );
    ...
    function getData() {
        ...
        $selectSlice = 'SELECT [BareBulb]
                            ...
                            ,[Backorder]';
        $from = ' FROM';
        $table = ' [Inventory].[dbo].[FP-Philips-Sales-Report] ';
        $where ='';

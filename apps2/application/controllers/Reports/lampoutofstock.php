...
class Lampoutofstock extends BP_Controller {
    ...
    public function index() {
        ...
        $data = array(
            ...
            'from' => '/Reports/lampoutofstock/',
            'nameGrid' => 'lampoutofstock',
            'namePager' => 'lampoutofstockPager',
            'caption' => 'Lamp out of stock',
            'subgrid' => 'false',
            'sort' => 'desc',
            'search' => '',
            'status' => 0,
            ...
            'dateto' => date("m/d/Y"),
            'export' => 'lampoutofstock',
            'customerid' => $this->MUsers->getCustomerId($this->session->userdata('userid'))
        );


        //Cargamos al arreglo los colnames
        $data['colNames'] = "['SKU','Name','CurrentStock','PendingShipment','Remaining','BackOrders','AvgSalePrice']";
        //Cargamos al arreglo los colmodels
        $data['colModel'] = "[
                {name:'SKU',index:'OrderNumber', width:70, align:'center'},
                {name:'Name',index:'SKU', width:550, align:'left'},
                {name:'CurrentStock',index:'WebSKU', align:'center'},
                {name:'PendingShipment',index:'Product', align:'center'},
                {name:'Remaining',index:'CustomerID', align:'center'},
                {name:'BackOrders',index:'QuantityOrdered', align:'center'},
	...
	$orderby = ' Order by Remaining ASC';

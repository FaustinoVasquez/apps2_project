...
class Pendingorders extends BP_Controller {
    ...
    public function index() {
        ...
        $data['colNames'] = "['Order#','Reference#','Order Date ','Order Status','CustomerID','CartID','Shipping Method','Ship To']";
    ...
    function dataPendOrd() {
        ...
        $wherefields = array('OrderNumber', 'SourceOrderNumber,', 'OrderDate', 'OrderStatus', 'CustomerID','Shipping','ShipName');
    ...
    function trackingData() {
        ...
        $SQL = "SELECT c.sku,
                ...
                FROM 
                      ...
                      left join [OrderManager].[dbo].[Order Details] c on (b.ordernum = c.OrderNumber)
                WHERE 
                       (isnumeric(sku) = 1)
                       AND 
                       (b.ordernum = {$orderNumber})";

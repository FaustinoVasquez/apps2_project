...
public function index()
    {
        ...
        $this->description = "Amazon Merge Items";
        ...
        $data = array(
            ...
            'from' => '/channelManagement/amazonmerge/',
...
public function getData()
    {
        ...
        $where .= "and ([AZMapping-Merged].[BrandSell] != [AZMapping-Retained].[BrandSell]) AND ([AZMapping-Merged].[BrandSell] != 'Compatible')";
...
public function getData1()
    {
        ...
        $where .= $this->MCommon->concatAllWerefields($wherefields, $search);
        $where .= " and (([AZMapping-Merged].[BrandSell] = [AZMapping-Retained].[BrandSell]) OR ([AZMapping-Merged].[BrandSell] = 'Compatible') ) AND [AZMapping-Retained].[ProductCatalogId] is null ";
 ...
 public function getData2()
    {
        ...
        $where .= $this->MCommon->concatAllWerefields($wherefields, $search);
        $where .= " and (([AZMapping-Merged].[BrandSell] = [AZMapping-Retained].[BrandSell]) OR ([AZMapping-Merged].[BrandSell] = 'Compatible')) AND ([AZMapping-Retained].[ProductCatalogId] != [AZMapping-Merged].[ProductCatalogId]) AND [AZMapping-Retained].[ProductCatalogId] is not null ";

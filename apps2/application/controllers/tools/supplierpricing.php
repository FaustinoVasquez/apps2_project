...
class SupplierPricing extends BP_Controller {
    ...
    function index() { 
        ...
        $data['colNames'] = "['ID','SupplierID','SupplierName','MITSKU','SupplierSKU','Description','UnitCost','LandedUnitCost','DeliveryTimeDays','DropShip?','SKUEnabled','Category']";
        ...
        $data['colModel'] = "[
                ...
                {name:'LandedUnitCost',index:'LandedUnitCost', width:45, align:'center', editable:true, sorttype: 'int',editrules:{number:true}},
    ...
    function getData() {
        ...
        $from =  " FROM (
                    SELECT SUP.[ID]
                        ...
                        ,SUP.[LandedUnitCost] AS 'LandedUnitCost'
      ...
      //  $fields = $this->MCommon->getAllfields($table);
        ...
        foreach ($result as $row) {
            ...
            $responce->rows[$i]['cell'] = array($row['ID'],
                ...
                $row['LandedUnitCost'] = utf8_encode($row['LandedUnitCost']),
    ...
    function editSupplier()
    {
        ...
        if (isset($_POST['LandedUnitCost'])) {
                $LandedUnitCost = $_POST['LandedUnitCost'];
                $SQL = "UPDATE [Inventory].[dbo].[Suppliers] SET LandedUnitCost={$LandedUnitCost} WHERE ID={$sup}";
        }

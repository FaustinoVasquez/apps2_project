...
$channelsSelect = 'class="form-select" id="channelsMenu"';
$priceCheckbox = array('name' => 'floorPrice', 'id' => 'floorPrice', 'value' => 'TRUE', 'checked' => $floorprice, 'class' => 'checkbox');
        ...
        <center>
            <table>
                ...
                <tr>
                    ...
                    <td><?=form_dropdown('channelsMenu', $channels,'0', $channelsSelect);?></td>
                    <td><label><?=form_checkbox($priceCheckbox); ?> FloorPriceOverride</label></td>
    ...
    $(document).ready(function(){
        ...
        myGrid.jqGrid({
            ...
            postData: {
                ...
                chan:  function() { return jQuery("#channelsMenu option:selected").val(); },
                fp:   function() { return jQuery("#floorPrice").attr('checked'); },
            },
            datatype: "json",
            colNames:<?= $colNames ?>,
            colModel:<?= $colModel ?>,

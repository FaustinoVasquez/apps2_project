...
<?php
$formopen = array('id' => 'amazontophiips', 'name' => "amazontophiips", 'class' => 'myform');
...
$Checkbox = array('name' => 'instock', 'id' => 'instock', 'value' => 'TRUE', 'checked' => $instock, 'onChange' => "this.form.submit()", 'class' => 'checkbox');

echo "<label>Search:</label>" . form_input($inputsearch);
echo '<br>';
echo '<label>'.form_checkbox($Checkbox).'Only show ASIN\'s where Philips is available and in-stock.</label>';



echo "&nbsp;&nbsp;";
$submit = array('id'=>'send', 'name' => 'send', 'value' => 'Submit', 'type' => 'submit', 'class' => 'button');
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        jQuery("<?= '#' . $nameGrid ?>").jqGrid('navGrid','<?= '#' . $namePager ?>',{cloneToTop:true,edit:false,add:false,del:false,search:true,refresh:true},

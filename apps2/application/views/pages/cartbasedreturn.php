...
<?php
$inputsearch = array('id'=>'search','name' => 'search', 'value' =>$search, 'autocomplete' => 'on', 'maxlength' => '250', 'size' => '20');
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        myGrid.jqGrid({
            ...
            toppager:true,
            cellEdit: true,
	        cellurl:'<?= base_url() . 'index.php' . $from . 'saveData' ?>'
        });
    ...
    function formatLink(cellvalue, options,rowData) {
        if (cellvalue!=null){    
            return "<a href= <?= base_url() . 'index.php/Catalog/prodcat/' ?>"+cellvalue+" target='_blank'>" + cellvalue + "</a>";
        }
    }

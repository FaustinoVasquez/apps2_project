...
<fieldset class="bluegradiant">
    ...
    <?php
        ...
        $inputsearch = array( 'name' => 'search'  , 'value'=> $datasearch ,'maxlength' => '15' , 'size' => '12' ,  'onChange' => "this.form.submit()",) ;
...
<script type="text/javascript">
	...
	onClickButton: function(){
     ...
     $(function() {
     $( "#mysku" ).autocomplete({
            source: "<?= base_url() ?>index.php/tools/buyonline/fillselect/"
      });
    });
    ...
    function formatLink(cellvalue, options,rowData) {
        if (cellvalue!=null){    
            return "<a href= <?= base_url() . 'index.php/tools/buyonline/' ?>"+cellvalue+" target='_blank'>" + cellvalue + "</a>";
        }
    }

    function formatLink2(cellvalue, options,rowData) {
        if (cellvalue!=null){  
            return "<a href=<?= base_url()  . 'index.php/Reports/purchaseorderlist/'?>"+'?q='+ rowData[2]+'&p='+ 0 +'&t='+ 1 +">" + cellvalue + "</a>";
        }  
    }

        ...
        myGrid.jqGrid({
            ...
            $("#"+subgrid_id).html("<div style='background-color:#363737;width:100%;'>\n\
                ...
                jQuery("#"+subgrid_table_id).jqGrid({ 
                    ...
                    datatype: "json",  
                    colNames: ['ParentSKU','Item','QOH','vQOH','tQOH'], 
                colModel: [ 
                    {name:'ParentSKU',index:'ParentSKU', width:60, align:'center'},
                    {name:'Item',index:'Item', width:300, align:'left'},
                    {name:'QOH',index:'QOH', width:60, align:'center'},
                    {name:'vQOH',index:'vQOH', width:60, align:'center'},
                    {name:'tQOH',index:'tQOH', width:80, align:'center'},
                ], 
                    width:1000,
                    rowNum:300,
                    rowList:[300,500,100000000],

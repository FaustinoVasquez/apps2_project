...
<fieldset class="bluegradiant">
    ...
    <?php
        ...
        echo '<br>';
        $Checkbox = array('name' => 'breakdown', 'id' => 'breakdown', 'value' => 'TRUE', 'checked' => $breakdown, 'onChange' => "this.form.submit()", 'class' => 'checkbox');
        echo '<label>'.form_checkbox($Checkbox).'Show Channel Breakdown.</label>';

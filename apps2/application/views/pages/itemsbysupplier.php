...
<fieldset class="bluegradiant">
    ...
    <div class="form-data"> 
        ...
        echo form_dropdown('selectedsupplier', $supplierOptions, isset($lineselect->selectedsupplier) ? $lineselect->selectedsupplier : $this->input->post('selectedsupplier'), $activatedropdown);

...
<script type="text/javascript">
    ...
    var ebaygrid = function (id,grid,pager,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,storename,cellurl,FeedID,gridurl){
    ...
    function checkboxFormatter(cellvalue, options, rowObject) {
        ...
        switch(id) {
        case 4:
            var colnames = ['FeedID','Title','TitleOverride','StoreCategory','MainCategory','UpsellLink','Template','Price','PriceOverride','IsActive'];
            var colmodel = [{name:field1,index:field1, width:80, align:'left', hidden:true},
                            ...
                            {name:field11,index:field11, width:50, align:'center', editable: true, formatter: checkboxFormatter, edittype: 'checkbox' },];
        ...
        case 6:
            ...
            var colmodel = [{name:field1,index:field1, width:80, align:'left', hidden:true},
                            {name:field12,index:field12, width:150, align:'left'},
                            {name:field13,index:field13, width:150, align:'left'},
                            {name:field14,index:field14, width:150, align:'left'}];
            break;
        default:
    ...
    $(document).ready(function(){
        ...
        myGrid.jqGrid({
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {    
                ...
                ebaygrid(4,'ml'+colData,'pager4','FeedID','MLMexicoTitle','MLMexicoTitleOverride','','MLMexicoStoreCategory','MLMexicoMainCategory','MLMexicoUpsellLink','MLMexicoTemplate','MLMexicoPrice','MLMexicoPriceOverride','MLMexicoIsActive','','','','ML-Mexico','storeEdit',colData,'store/4');
                ebaygrid(5,'ne'+colData,'pager5','FeedID','NewEgg1Title','NewEgg1TitleOverride','NewEgg1StoreName','','','NewEgg1UpsellLink','NewEgg1Template','NewEgg1Price','NewEgg1PriceOverride','NewEgg1IsActive','','','','NewEgg','storeEdit',colData,'store/5');
                ebaygrid(6,'tabs'+colData,'pager6','FeedID','','','','','','','','','','InsertedStamp','UpdatedStamp','MarkForDeletionStamp','Timestamp','storeEdit',colData,'store/6');
                });
            },
            loadComplete: function() {

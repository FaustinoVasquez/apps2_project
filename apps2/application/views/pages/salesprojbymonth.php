...
<div class="graphicContainter">
    <center>
        ...
        <?php
        $formopen = array('id' => "formsalesbymonth", 'class'=>'myform');
        echo form_open(base_url() . 'index.php' . $from, $formopen);

        
        echo form_label(' Year:', 'tyear');
        $Tyeardropdown = 'id="selectedTyear" class="form-select"';
        echo form_dropdown('selectedTyear', $TyearOptions,$selectedTyear , $Tyeardropdown);
        echo form_label(' Year:', 'fyear');
        $Fyeardropdown = 'id="selectedFyear" class="form-select" ';
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            chart1 = new Highcharts.Chart({
                ...
                title: {
                    text: 'Projector Sales By Month '+'<?= $selectedTyear?>'+' & '+'<?= $selectedFyear?>'
                },
                subtitle: {
